...
export const itemEntries: ItemEntry[] = [
  ...
  i('iron-boots', 'Iron Boots', 'Iron Boots', 'Botas', 'Adulto', 'Botas pesadas que fazem Link afundar e permitem caminhar no fundo da água.', 'Ice Cavern', 'Abra o baú principal da caverna de gelo.', 'Ice Cavern / preparação para Water Temple', ['zora-fountain', 'water-temple'], [], remake.ironBoots, 'Remake 2026', 'O trailer mostra Link caminhando submerso com as novas Iron Boots.'),
  ...
  i('boomerang', 'Boomerang', 'Boomerang', 'Arma', 'Criança', 'Arma de retorno que atordoa inimigos e busca itens distantes.', 'Interior de Jabu-Jabu', 'Abra o grande baú durante a dungeon.', 'Jabu-Jabu', ['jabu'], [], remake.boomerang, 'Remake 2026', 'O trailer mostra o novo Boomerang em voo dentro de Jabu-Jabu.'),
  ...
  i('fairy-bow', 'Fairy Bow', 'Fairy Bow', 'Arma', 'Adulto', 'Arco de Link adulto, usado em combate, puzzles e minijogos montado em Epona.', 'Templo da Floresta', 'Abra o grande baú após uma batalha importante no templo.', 'Templo da Floresta', ['forest-temple']),
  ...
  i('hookshot', 'Hookshot', 'Hookshot', 'Ferramenta', 'Adulto', 'Gancho com corrente que puxa Link até superfícies e recupera itens distantes.', 'Cemitério de Kakariko', 'Complete a corrida com Dampé dentro de sua tumba.', 'Corrida de Dampé', ['graveyard'], ['dampe-race'], remake.waterTemple, 'Remake 2026', 'O novo Hookshot aparece disparado no Water Temple no trailer.'),
