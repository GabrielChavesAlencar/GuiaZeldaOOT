...
export const itemEntries: ItemEntry[] = [
  // Espadas e escudos
  i('kokiri-sword', 'Kokiri Sword', 'Kokiri Sword', 'Arma', 'Criança', 'Espada curta de Link criança e sua primeira arma permanente.', 'Floresta Kokiri', 'Entre no túnel da área de treinamento e abra o baú no fim da passagem.', 'Preparativos na Floresta Kokiri', ['kokiri'], [], remake.equipment, 'Remake 2026', 'O novo modelo aparece na tela oficial de Equipment e em cenas do trailer.'),
  i('master-sword', 'Master Sword', 'Master Sword', 'Arma', 'Adulto', 'A espada lendária ligada ao Templo do Tempo e à alternância entre as eras.', 'Templo do Tempo', 'É obtida como parte da progressão principal no Pedestal of Time.', 'Templo do Tempo', ['temple-time'], [], remake.masterSword, 'Remake 2026', 'O trailer mostra a nova lâmina, guarda azul e Triforce com bastante clareza.'),
  ...
  i('deku-shield', 'Deku Shield', 'Deku Shield', 'Escudo', 'Criança', 'Escudo de madeira usado por Link criança; pode ser queimado por fogo.', 'Loja Kokiri', 'Compre por 40 Rupees antes de entrar na Grande Árvore Deku.', 'Preparativos na Floresta Kokiri', ['kokiri'], [], remake.shop, 'Remake 2026', 'O novo escudo aparece fisicamente na prateleira da Kokiri Shop e equipado no menu.'),
  ...
  i('kokiri-tunic', 'Kokiri Tunic', 'Kokiri Tunic', 'Roupa', 'Ambas', 'Túnica verde padrão de Link.', 'Inventário inicial', 'Link começa a aventura usando esta túnica.', 'Início da aventura', ['kokiri'], [], remake.equipment, 'Remake 2026', 'A tela de Equipment do remake mostra a nova modelagem da túnica.'),
  i('goron-tunic', 'Goron Tunic', 'Goron Tunic', 'Roupa', 'Adulto', 'Protege Link do calor extremo em áreas vulcânicas.', 'Cidade Goron', 'Receba do jovem Goron rolante ou compre na loja Goron.', 'Preparação para o Templo do Fogo', ['goron-city', 'fire-temple'], [], remake.fireTemple, 'Remake 2026', 'A nova túnica vermelha aparece no trailer dentro do Fire Temple.'),
  i('zora-tunic', 'Zora Tunic', 'Zora Tunic', 'Roupa', 'Adulto', 'Permite permanecer debaixo d’água sem limite de respiração.', 'Domínio Zora', 'Receba do Rei Zora depois de descongelá-lo ou compre na loja.', 'Preparação para o Templo da Água', ['zora-domain', 'water-temple'], [], remake.waterTemple, 'Remake 2026', 'A nova túnica azul aparece no trailer no Water Temple.'),
  ...
  i('iron-boots', 'Iron Boots', 'Iron Boots', 'Botas', 'Adulto', 'Botas pesadas que fazem Link afundar e permitem caminhar no fundo da água.', 'Ice Cavern', 'Abra o baú principal da caverna de gelo.', 'Ice Cavern / preparação para Water Temple', ['zora-fountain', 'water-temple'], [], `${official}/dungeon/item_adult_thumb_03.webp`, 'Remake 2026', 'O site japonês da Nintendo mostra as Iron Boots com o novo design na seção de itens das masmorras.'),
  ...
  i('golden-gauntlets', 'Golden Gauntlets', 'Golden Gauntlets', 'Acessório', 'Adulto', 'Maior upgrade de força, permitindo mover obstáculos gigantes.', 'Castelo de Ganon', 'Abra o baú na prova relacionada durante a área final.', 'Castelo de Ganon', ['ganon-castle'], [], remake.goldenGauntlets, 'Remake 2026', 'O trailer mostra a Golden Gauntlet no braço de Link durante a batalha final.'),
  ...
  i('boomerang', 'Boomerang', 'Boomerang', 'Arma', 'Criança', 'Arma de retorno que atordoa inimigos e busca itens distantes.', 'Interior de Jabu-Jabu', 'Abra o grande baú durante a dungeon.', 'Jabu-Jabu', ['jabu'], [], `${official}/dungeon/item_child_thumb_02.webp`, 'Remake 2026', 'O site japonês da Nintendo mostra o Boomerang com o novo design na seção de itens das masmorras.'),
  ...
  i('hookshot', 'Hookshot', 'Hookshot', 'Ferramenta', 'Adulto', 'Gancho com corrente que puxa Link até superfícies e recupera itens distantes.', 'Cemitério de Kakariko', 'Complete a corrida com Dampé dentro de sua tumba.', 'Corrida de Dampé', ['graveyard'], ['dampe-race'], `${official}/dungeon/item_adult_thumb_01.webp`, 'Remake 2026', 'O site japonês da Nintendo mostra o Hookshot com o novo design na seção de itens das masmorras.'),
  ...
  i('megaton-hammer', 'Megaton Hammer', 'Megaton Hammer', 'Arma', 'Adulto', 'Martelo pesado que quebra rochas e ativa mecanismos.', 'Templo do Fogo', 'Abra o grande baú na parte alta do templo.', 'Templo do Fogo', ['fire-temple'], [], remake.fireTemple, 'Remake 2026', 'O trailer mostra o novo martelo acertando uma estátua Goron.'),
