...
export const npcEntries: NpcEntry[] = [
  npc('zelda', 'Princesa Zelda', 'Princess Zelda', 'Principal', 'Princesa de Hyrule', 'Castelo de Hyrule', 'Ambas', 'Princesa de Hyrule, curiosa e atenta aos acontecimentos do reino.', 'https://www.nintendo.com/jp/games/switch2/aa9ja/assets/img/triforce/zelda_pic.webp', 'Remake 2026'),
  npc('sheik', 'Sheik', 'Sheik', 'Principal', 'Guia misterioso', 'Diversas regiões de Hyrule', 'Adulto', 'Aparece durante a fase adulta para orientar Link e ensinar canções importantes.', 'https://www.nintendo.com/jp/games/switch2/aa9ja/assets/img/hyrule/npc_pic_sheik.webp', 'Remake 2026'),
  npc('ganondorf', 'Ganondorf', 'Ganondorf', 'Antagonista', 'Rei dos Gerudo', 'Hyrule / território Gerudo', 'Ambas', 'Rei dos Gerudo e uma poderosa figura política interessada no poder de Hyrule.', 'https://www.nintendo.com/jp/games/switch2/aa9ja/assets/img/triforce/ganondorf_pic.webp', 'Remake 2026'),
  ...
  npc('impa', 'Impa', 'Impa', 'Principal', 'Protetora da família real', 'Castelo de Hyrule / Kakariko', 'Ambas', 'Sheikah ligada à Princesa Zelda e à história de Kakariko.', 'https://www.nintendo.com/jp/games/switch2/aa9ja/assets/img/hyrule/npc_pic_impa.webp', 'Remake 2026'),
  ...
  npc('saria', 'Saria', 'Saria', 'Aliado', 'Amiga de infância de Link', 'Floresta Kokiri / Bosque Sagrado', 'Ambas', 'Kokiri muito próxima de Link, ligada à floresta e à música.', 'https://www.nintendo.com/jp/games/switch2/aa9ja/assets/img/hyrule/npc_pic_saria.webp', 'Remake 2026'),
  npc('darunia', 'Darunia', 'Darunia', 'Aliado', 'Líder dos Gorons', 'Cidade Goron / Montanha da Morte', 'Ambas', 'Líder carismático dos Gorons, muito ligado ao bem-estar de seu povo.', 'https://www.nintendo.com/jp/games/switch2/aa9ja/assets/img/hyrule/npc_pic_darunia.webp', 'Remake 2026'),
  npc('ruto', 'Princesa Ruto', 'Princess Ruto', 'Aliado', 'Princesa Zora', 'Domínio Zora / Fonte Zora', 'Ambas', 'Princesa dos Zora, conhecida por sua personalidade forte e direta.', 'https://www.nintendo.com/jp/games/switch2/aa9ja/assets/img/hyrule/npc_pic_ruto.webp', 'Remake 2026'),
  ...
  npc('kaepora', 'Kaepora Gaebora', 'Kaepora Gaebora', 'Aliado', 'Coruja guia', 'Diversas regiões', 'Criança', 'Coruja sábia que orienta Link nos primeiros passos da aventura.', 'https://www.nintendo.com/jp/games/switch2/aa9ja/assets/img/hyrule/npc_pic_kepora.webp', 'Remake 2026'),
  ...
  npc('koume', 'Koume', 'Koume', 'Antagonista', 'Bruxa do fogo', 'Região do deserto', 'Ambas', 'Bruxa Gerudo ligada ao fogo e frequentemente associada a Kotake.'),
