...
export const npcEntries: NpcEntry[] = [
  ...
  npc('malon', 'Malon', 'Malon', 'Aliado', 'Moradora do Rancho Lon Lon', 'Rancho Lon Lon', 'Ambas', 'Ligada a Epona e a vários eventos opcionais do rancho.', '/malon-remake.png', 'Remake 2026', 'Agora Malon usa uma imagem dedicada do remake. Ela aparece ao lado do jovem Link, com cabelos longos vermelho-alaranjados, vestido branco com bordado azul na barra e um lenço amarelo sobre os ombros. O enquadramento reforça o clima campestre do Rancho Lon Lon, com grama alta e cercas de madeira ao fundo.', 'https://www.nintendo.com/jp/games/switch2/aa9ja/hyrule/index.html'),
