...
export const npcEntries: NpcEntry[] = [
  npc('zelda', 'Princesa Zelda', 'Princess Zelda', 'Principal', 'Princesa de Hyrule', 'Castelo de Hyrule', 'Ambas', 'Princesa de Hyrule, curiosa e atenta aos acontecimentos do reino.', 'https://z64central.com/switch-2/hyrule-castle-switch-2-remake-zelda-2_hu_750ff04710f6f399.webp', 'Remake 2026'),
  ...
  npc('ganondorf', 'Ganondorf', 'Ganondorf', 'Antagonista', 'Rei dos Gerudo', 'Hyrule / território Gerudo', 'Ambas', 'Rei dos Gerudo e uma poderosa figura política interessada no poder de Hyrule.', 'https://z64central.com/switch-2/ganons-castle-switch-2-remake-ganondorf-closeup-1_hu_cbf99b05d7b275ba.webp', 'Remake 2026'),
  ...
  npc('saria', 'Saria', 'Saria', 'Aliado', 'Amiga de infância de Link', 'Floresta Kokiri / Bosque Sagrado', 'Ambas', 'Kokiri muito próxima de Link, ligada à floresta e à música.', 'https://z64central.com/switch-2/kokiri-forest-switch-2-remake-saria-goodbye-2_hu_3ba2368b7a6cb9bf.webp', 'Remake 2026'),
  npc('darunia', 'Darunia', 'Darunia', 'Aliado', 'Líder dos Gorons', 'Cidade Goron / Montanha da Morte', 'Ambas', 'Líder carismático dos Gorons, muito ligado ao bem-estar de seu povo.', 'https://z64central.com/switch-2/goron-city-switch-2-remake-darunia_hu_b3c5b92001d68744.webp', 'Remake 2026'),
  npc('ruto', 'Princesa Ruto', 'Princess Ruto', 'Aliado', 'Princesa Zora', 'Domínio Zora / Fonte Zora', 'Ambas', 'Princesa dos Zora, conhecida por sua personalidade forte e direta.', 'https://z64central.com/switch-2/jabu-jabus-belly-switch-2-remake-ruto_hu_72178b245be3b870.webp', 'Remake 2026'),
